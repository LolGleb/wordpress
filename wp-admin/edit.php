...
// Добавляем сообщение уровня info
$error->add( 'info', 'This is an info message' );

// Добавляем сообщение уровня warning
$error->add( 'warning', 'This is a warning message' );

// Добавляем сообщение уровня error
$error->add( 'error', 'This is an error message' );
/**
