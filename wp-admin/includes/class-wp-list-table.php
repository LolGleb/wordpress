...
<p class="search-box">
	...
	public function display() {
        ...
        define('WP_DEBUG_LOG', true);// Запись отладочной информации в wp-content/debug.log
        define('WP_DEBUG_DISPLAY', false);
        echo non_existent_function();
        echo $undefined_variable;
        // Генерация ошибки для отладки
        trigger_error("Это ошибка в режиме отладки!", E_USER_NOTICE);
